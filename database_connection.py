...
con = mysql.connector.connect(
    host="localhost",
    user="root",
    password="Mauagrace123@",
    database="code_with_adora"
)
...
def Add_Employ():
	...
	if(check_employee(Id) == True):
		...
		# the Employee Table
		sql = 'insert into code_with_adora values(%s,%s,%s,%s)'
		c = con.cursor()
...
def Promote_Employee():
	...
	if(check_employee(Id) == False):
		...
		# with given Id
		sql = 'select salary from code_with_adora where id=%s'
		data = (Id,)
		c = con.cursor()
		...
		# given Id
		sql = 'update code_with_adora set salary=%s where id=%s'
		d = (t, Id)
...
def Remove_Employ():
	...
	if(check_employee(Id) == False):
		...
		sql = 'delete from code_with_adora where id=%s'
		data = (Id,)
		c = con.cursor()
...
def check_employee(employee_id):
	...
	# rom employee Table
	sql = 'select * from code_with_adora where id=%s'
...
def Display_Employees():
	...
	# Employee Table
	sql = 'select * from code_with_adora'
	c = con.cursor()
